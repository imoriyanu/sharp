...
const s = StyleSheet.create({
  ...
  hidden: { fontSize: fp(10), color: colors.text.muted, marginBottom: spacing.lg },
  timer: { fontSize: fp(48), fontWeight: typography.weight.black, color: colors.text.primary, letterSpacing: -2 },
  ready: { fontSize: fp(10), fontWeight: typography.weight.bold, color: colors.text.muted, letterSpacing: 1, marginBottom: spacing.xl },
