...
const s = StyleSheet.create({
  ...
  stepText: { fontSize: fp(10), fontWeight: typography.weight.black, color: colors.accent.primary, letterSpacing: 1.5 },
  ...
  docType: { fontSize: fp(10), fontWeight: typography.weight.bold, color: colors.accent.primary, textTransform: 'uppercase' as const },
