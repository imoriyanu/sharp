...
const s = StyleSheet.create({
  ...
  badge: { fontSize: fp(10), fontWeight: typography.weight.heavy, color: colors.duel.text, textTransform: 'uppercase' as const, letterSpacing: 1.5, marginTop: wp(3), marginBottom: spacing.xl },
